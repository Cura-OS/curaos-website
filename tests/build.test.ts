...
const CASES: ReadonlyArray<readonly [string, (s: Record<string, any>) => void, string]> = [
  ...
  [
    ...
    (s) => delete s.footer.columns[0].heading,
    'footer.columns[0].heading',
  ],
  [
    'footer.columns[].links missing',
    (s) => delete s.footer.columns[0].links,
    'footer.columns[0].links',
  ],
  [
    'footer.columns[].links empty',
    (s) => (s.footer.columns[0].links = []),
    'footer.columns[0].links',
  ],
  [
    'footer.columns[].links[].label',
    (s) => delete s.footer.columns[0].links[0].label,
    'footer.columns[0].links[0].label',
  ],
  [
    'footer.columns[].links[].href',
    (s) => delete s.footer.columns[0].links[0].href,
